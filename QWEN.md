...
Use this file for Qwen. For Claude use `claude.md`, for Gemini use `GEMINI.md`, and for custom/other agents use `AGENT.md`. Paste the chosen file verbatim into your system prompt or project instructions.
