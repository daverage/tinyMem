...
set GOOS=windows
set GOARCH=amd64
go build -o releases/tinymem-windows-amd64.exe ./cmd/tinymem
...
set GOOS=windows
set GOARCH=arm64
go build -o releases/tinymem-windows-arm64.exe ./cmd/tinymem
...
set GOOS=linux
set GOARCH=amd64
go build -o releases/tinymem-linux-amd64 ./cmd/tinymem
...
set GOOS=linux
set GOARCH=arm64
go build -o releases/tinymem-linux-arm64 ./cmd/tinymem
...
set GOOS=darwin
set GOARCH=amd64
go build -o releases/tinymem-darwin-amd64 ./cmd/tinymem
...
set GOOS=darwin
set GOARCH=arm64
go build -o releases/tinymem-darwin-arm64 ./cmd/tinymem
