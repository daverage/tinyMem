...
CREATE TEMPORARY TABLE temp_current_version AS SELECT user_version FROM pragma_user_version();
...
-- Migration v1: Initial schema (handled by CREATE TABLE IF NOT EXISTS above)
